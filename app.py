...
<title>Activar notificaciones — Guía paso a paso</title></head>
<body>
<h1>Activación básica</h1>
<p>Usa /push/vapid-public, /push/subscribe y /push/test. Esta versión reducida evita ruido en app.py.</p>
</body></html>
'''
    return html
